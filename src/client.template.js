...
.bwm-restore{position:fixed;right:14px;bottom:14px;z-index:1500;border:2px solid #4854a6;
  background:#ffffff;color:#4854a6;border-radius:0;padding:5px 12px;
  font:700 12px/1 -apple-system,"PingFang SC",sans-serif;cursor:pointer;
  box-shadow:3px 3px 0 rgba(72,84,166,.25);pointer-events:auto}
.bwm-restore:hover{background:#eef1fb}
.bwm-balance-btn{position:absolute;right:2px;bottom:2px;width:22px;height:22px;border:2px solid #4854a6;
  border-radius:0;background:#ffffff;color:#4854a6;
  font:700 13px/18px -apple-system,"PingFang SC",sans-serif;text-align:center;cursor:pointer;
  box-shadow:2px 2px 0 rgba(72,84,166,.35);padding:0;line-height:18px;
  opacity:.55;transition:opacity .15s,transform .08s,box-shadow .08s;z-index:1501}
.bwm-root:hover .bwm-balance-btn{opacity:1}
.bwm-balance-btn:hover{opacity:1;transform:translate(-1px,-1px);box-shadow:3px 3px 0 rgba(72,84,166,.4)}
.bwm-balance-btn:active{transform:translate(1px,1px);box-shadow:1px 1px 0 rgba(72,84,166,.4)}

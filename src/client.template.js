...
.bwm-balance-btn{position:absolute;right:0;bottom:0;min-width:20px;height:20px;border:2px solid #4854a6;
  border-radius:0;background:#ffffff;color:#4854a6;padding:0 5px;
  font:700 11px/16px -apple-system,"PingFang SC",sans-serif;text-align:center;cursor:pointer;
  box-shadow:2px 2px 0 rgba(72,84,166,.35);
  opacity:.6;transition:opacity .15s,transform .08s,box-shadow .08s;z-index:1501;
...
.bwm-balance-btn.bwm-loading{color:#8b93c0;animation:bwm-blink 1s steps(2) infinite}
